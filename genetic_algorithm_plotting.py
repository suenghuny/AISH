...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        df_dict = {}
        records = list()
        solution_space = [[i/10 for i in range(-1000, 1000)], [i/10  for i in range(0, 2000)],
                          [i/10  for i in range(-1000, 1000)], [i/10  for i in range(0, 2000)], [i/10 for i in range(0,4000)],
